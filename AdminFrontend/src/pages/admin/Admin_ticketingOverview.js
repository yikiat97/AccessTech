    ...
    return(      
        <div className="overlay">
            <div className="centerContent">
                <Heading>Which category would you like to access?</Heading>
                <SimpleGrid columns={2}>
                    <LinkBox as='article' maxW='sm' p='5' m='5' borderWidth='1px' rounded='md'>
                        ...
                        <Heading size='md' my='2'>
                            <LinkOverlay href='/AccessTech/SandwichTicketingPage'>
                                Sandwiches
                            </LinkOverlay>
                        </Heading>
                    </LinkBox>
                    ...
                    <LinkBox as='article' maxW='sm' p='5' m='5' borderWidth='1px' rounded='md'>
                        ...
                        <Heading size='md' my='2'>
                            <LinkOverlay href='/AccessTech/NoodlesTicketingPage'>
                                Noodles
                            </LinkOverlay>
                        </Heading>
                    </LinkBox>
